{
  ...
  outputs =
    ...
    let
      ...
      inherit (lib') flattenAttrsDot flattenAttrsSlash mapAttrByPath;
      ...
      rawExamples = flattenAttrsSlash (
        mapAttrs (_: v: mapAttrs (_: v: v.path) v) (
          mapAttrByPath [
            "nixos"
            "examples"
          ] { } rawNgiProjects
      ...
      extendedNixosModules = nixosModules // {
      ...
      systemAgnosticOutputs = {
        nixosConfigurations = extendedNixosConfigurations // {
      ...
      eachDefaultSystemOutputs = flake-utils.lib.eachDefaultSystem (
        ...
        let
          ...
          nonBrokenNgiPackages = filterAttrs (
            _: v:
            !(attrByPath [
              "meta"
              "broken"
        ...
        rec {
          legacyPackages = {
            nixosTests = mapAttrByPath [
              "nixos"
              "tests"
            ] { } ngiProjects;
          };

          packages = ngiPackages // {
          ...
          checks =
            let
              ...
              checksForPackagePassthruTests =
                packageName: tests:
                (concatMapAttrs (passthruName: test: {
